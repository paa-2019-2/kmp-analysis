...
\begin{proof}
        Aplicando os lemas \ref{mergesort-sorts} e \ref{mergesort-is-permutation}, as propriedades as quais
        deseja-se demonstrar tornam-se evidentes. 
\end{proof}
