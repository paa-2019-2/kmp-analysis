...
%   /home/nunesgrf/projetos/pvsdir/pvs-tex.sub
...
\begin{alltt}
\pvsid{merge\_sort\_correctness}: \pvskey{THEORY}
 \pvskey{BEGIN}

  \pvskey{IMPORTING} \pvsid{sorting}, \pvsid{mergesort}

  \(l\), \(l\sb{1}\), \(l\sb{2}\): \pvskey{VAR} \pvsid{list}\({\pvsbracketl}\)\(\mathbb{N}\)\({\pvsbracketr}\)\vspace*{\pvsdeclspacing}

  \pvsid{merge\_preserves\_occurrences}: \pvskey{LEMMA}
    \pvskey{forall} \pvsid{(}\(l\sb{1}\), \(l\sb{2}\): \pvsid{list}\({\pvsbracketl}\)\(\mathbb{N}\)\({\pvsbracketr}\), \(n\): \(\mathbb{N}\)\pvsid{)}:
      \(\opplustwofn{\pvsid{occurrences}\pvsid{(}l\sb{1}\pvsid{)}\pvsid{(}n\pvsid{)}}{\pvsid{occurrences}\pvsid{(}l\sb{2}\pvsid{)}\pvsid{(}n\pvsid{)}}\) \(=\)
       \pvsid{occurrences}\pvsid{(}\pvsid{merge}\pvsid{(}\(l\sb{1}\), \(l\sb{2}\)\pvsid{)}\pvsid{)}\pvsid{(}\(n\)\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{append\_null\_2}: \pvskey{LEMMA} \pvskey{forall} \pvsid{(}\(l\): \pvsid{list}\({\pvsbracketl}\)\(\mathbb{N}\)\({\pvsbracketr}\)\pvsid{)}: \pvsid{append}\pvsid{(}\pvsid{null}, \(l\)\pvsid{)} \(=\) \(l\)\vspace*{\pvsdeclspacing}

  \pvsid{merge\_preserves\_len}: \pvskey{LEMMA}
    \pvskey{forall} \pvsid{(}\(l\sb{1}\), \(l\sb{2}\): \pvsid{list}\({\pvsbracketl}\)\(\mathbb{N}\)\({\pvsbracketr}\)\pvsid{)}:
      \(\opplustwofn{\pvsid{length}\pvsid{(}l\sb{1}\pvsid{)}}{\pvsid{length}\pvsid{(}l\sb{2}\pvsid{)}}\) \(=\) \pvsid{length}\pvsid{(}\pvsid{merge}\pvsid{(}\(l\sb{1}\), \(l\sb{2}\)\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{merge\_permutes}: \pvskey{LEMMA}
    \pvskey{forall} \pvsid{(}\(l\sb{1}\), \(l\sb{2}\): \pvsid{list}\({\pvsbracketl}\)\(\mathbb{N}\)\({\pvsbracketr}\)\pvsid{)}:
      \pvsid{permutations}\pvsid{(}\pvsid{append}\pvsid{(}\(l\sb{1}\), \(l\sb{2}\)\pvsid{)}, \pvsid{merge}\pvsid{(}\(l\sb{1}\), \(l\sb{2}\)\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{merge\_keep\_sorted}: \pvskey{LEMMA}
    \pvskey{forall} \pvsid{(}\(l\sb{1}\), \(l\sb{2}\): \pvsid{list}\({\pvsbracketl}\)\(\mathbb{N}\)\({\pvsbracketr}\)\pvsid{)}:
      \pvsid{is\_sorted?}\pvsid{(}\(l\sb{1}\)\pvsid{)} \(\wedge\) \pvsid{is\_sorted?}\pvsid{(}\(l\sb{2}\)\pvsid{)} \(\supset\) \pvsid{is\_sorted?}\pvsid{(}\pvsid{merge}\pvsid{(}\(l\sb{1}\), \(l\sb{2}\)\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{mergesort\_preserves\_len}: \pvskey{LEMMA}
    \pvskey{forall} \pvsid{(}\(l\): \pvsid{list}\({\pvsbracketl}\)\(\mathbb{N}\)\({\pvsbracketr}\)\pvsid{)}: \pvsid{length}\pvsid{(}\(l\)\pvsid{)} \(=\) \pvsid{length}\pvsid{(}\pvsid{merge\_sort}\pvsid{(}\(l\)\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{mergesort\_permutes}: \pvskey{LEMMA}
    \pvskey{forall} \pvsid{(}\(l\): \pvsid{list}\({\pvsbracketl}\)\(\mathbb{N}\)\({\pvsbracketr}\)\pvsid{)}: \pvsid{permutations}\pvsid{(}\(l\), \pvsid{merge\_sort}\pvsid{(}\(l\)\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{mergesort\_sorts}: \pvskey{LEMMA}
    \pvskey{forall} \pvsid{(}\(l\): \pvsid{list}\({\pvsbracketl}\)\(\mathbb{N}\)\({\pvsbracketr}\)\pvsid{)}: \pvsid{is\_sorted?}\pvsid{(}\pvsid{merge\_sort}\pvsid{(}\(l\)\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

  \pvsid{mergesort\_correctness}: \pvskey{THEOREM}
    \pvskey{forall} \pvsid{(}\(l\): \pvsid{list}\({\pvsbracketl}\)\(\mathbb{N}\)\({\pvsbracketr}\)\pvsid{)}:
      \pvsid{is\_sorted?}\pvsid{(}\pvsid{merge\_sort}\pvsid{(}\(l\)\pvsid{)}\pvsid{)} \(\wedge\)
       \pvsid{permutations}\pvsid{(}\(l\), \pvsid{merge\_sort}\pvsid{(}\(l\)\pvsid{)}\pvsid{)}\vspace*{\pvsdeclspacing}

 \pvskey{END} \pvsid{merge\_sort\_correctness}\end{alltt}
